  ...
  const handleInputKeyDown = (
    ...
    if (e.key === 'Enter' && field.name === 'tags') {
      ...
      if (tagValue !== '') {
        ...
        // checking to ensure the tag doesn't exist already.
      ...
      <form
              ...
              <FormControl className='mt-3.5'>
                <Editor
                  ...
                  init={{
                    ...
                    content_style:
                      'body { font-family:Inter,Helvetica; font-size:16px }',
                  }}
                />
              </FormControl>
              <FormDescription className='body-regular mt-2.5 text-light-500'>
                Introduce the problem and expand on your title. Min 20 chars.
              </FormDescription>
              <FormMessage className='text-red-500' />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex w-full flex-col'>
              ...
              <FormControl className='mt-3.5'>
                {/* form control can only take one element so we wrap the input and map function in a fragment so its viewed
                as one element */}
                <>
                  <Input
        ...
        <Button
          ...
          {isSubmitting ? (
            ...
            <>
              {' '}
              {/* fragment because we might want to add icons to it later */}
